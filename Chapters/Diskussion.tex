...
Ein Ping wird von PC1 zu PC3 gesendet. Hierbei werden \acs{ICMP}v6- und
\acs{NDP}-Pakete gefiltert. Im folgenden Sequenzdiagramm ist der Ablauf der
Pakete dargestellt.
...
wird der Echo Request fortgesetzt und erreicht PC3.
\newline
...
nutzt. Die ICMPv6-Nachrichten verhalten sich äquivalent zu ICMP-Nachrichten bei
IPv4.
\section{Fazit}
