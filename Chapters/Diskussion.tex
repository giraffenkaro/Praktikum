...
von IPv6-\acsp{LAN} gesammelt werden. Darüber hinaus konnte das Wissen über die
...
Um mehr darüber zu erfahren und die Theorien aus \ref{multi} zu bestätigen,
wird im Folgenden ein weiteres Szenario überprüft.
...
Zum Verständnis diente der \acs{RFC} 4291, \citetitle{RFC4291}. Darüber hinaus
...
\begin{figure}[!htbp]
  ...
  \label{fig:aufbau}
\end{figure}
Zunächst wird eine NDP-Anfrage (Neighbor-Solicitation-Nachricht) mit Message
...
\newline
Es folgt ein weiteres NDP-Paket mit Message Type 135 von PC3 zu Router 3. Dieser
antwortet wieder mit einem NDP-Paket des Typs 136.
\newline
Im Anschluss beginnt die Echo Reply Nachricht von PC3. Bei Router 1 angekommen,
wird erneut ein NDP-Paket versandt. Ziel der Neighbor-Solicitation-Nachricht ist
PC1, welcher mit einer Neighbor-Advertisement-Nachricht antwortet.
\newline
