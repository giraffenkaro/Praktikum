...
Der Laborversuch beschäftigt sich mit einer Einführung in die Konfiguration von
...
Aus organisatorischen Gründen wurde dieser Laborversuch mittels
Cisco PacketTracer durchgeführt.
...
\small
	...
	\hline
	\end{tabularx}
\caption{Konfiguration für Teil 1}
\label{config1}
\end{table}
...
\begin{itemize}
  ...
  \item Überprüfung der Netzwerk-Verbindungen
...
Der zweite Teil beschäftigt sich mit einem Szenario in dem Unternehmen WTH.\\
Zunächst ist ein Switch zu konfigurieren und die angeschlossenen PCs der
Abteilungen ``Produktion'' und ``Verwaltung'' mittels VLANs zu trennen.
\newline
Im nächsten Schritt sollen aufgrund von Kapazitätserweiterungen im
Nebengebäude neue Arbeitsplätze für beide Abteilungen geschaffen werden. Somit
wird ein zusätzlicher Switch angeschafft. Nach der Konfiguration sollen die Abteilungen
intern gebäudeübergreifend kommunizieren können.
\newline
Nach einer Lockerung der Firmenpolitik soll es auch möglich sein, dass die
Abteilungen untereinander kommunizieren können. Mit einem Router soll das
Routing zwischen den VLANs realisiert werden.

\section{Versuchsziel}
Der Laborversuch dient der Einführung in die Konfiguration von Cisco Switches,
in diesem Fall dem Modell Cisco 2960.\\Außerdem sollen Sinn und Zweck von VLANs
veranschaulicht werden, besonders durch den zweiten Teil, der sich mit einem
fiktiven Szenario der Firma WTH beschäftigt.
