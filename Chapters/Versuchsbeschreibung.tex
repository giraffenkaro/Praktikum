...
\begin{itemize}
  ...
  \begin{itemize}
    \item Router 1: 
    \begin{itemize}
      \item Verbindung zu PC1 mittels DE-9 zu RJ45 Adapterkabel
      \item Verbindung zum Switch durch Straight-Through-Kabel
	\end{itemize}
	\item Router 2:
	\begin{itemize}
    \item Verbindung zu PC2 durch Crossover-Kabel und DE-9 zu RJ45 Adapterkabel
    \end{itemize}
...
aufgebaut und wie folgt konfiguriert:\\ %TODO Tabelle einfügen
...
\begin{itemize}
  ...
  \item Router so konfigurieren, dass keine Adressauflösung für Hostnamen
  durchgeführt wird
  \item Synchrones ``console logging'' konfigurieren
  \item Verbindung der Hosts und Router überprüfen
\end{itemize}

\subsection{Teil 2}\label{subnet}
Der zweite Teil des Versuchs ist analog durchzuführen.\\Gegeben ist der
Adressbereich 192.168.1.0/24. Die Anforderungen an das zu gestaltende Netzwerk
sind:
\begin{itemize}
  \item das \acs{LAN} von Router 1 soll über IP-Adressen für 120 Hosts verfügen
  \item das \acs{LAN} von Router 2 soll über IP-Adressen für 60 Host verfügen
\end{itemize}
Das weitere Vorgehen gestaltet sich äquivalent zum ersten Teil des
Laborversuchs.
Zusätzlich wird \acs{RIP}-Routing konfiguriert.


\section{Versuchsziel}

Dieser Versuch dient als Einführung zur Netzwerkgestaltung und
-Konfiguration.%TODO ergänzen
