...
\section{Routingtabellen}\label{routingtables}

\subsection{Router 1 vor RIP Konfiguration}\label{routeStep6}
\begin{lstlisting}
R1#show ip route
...
\subsection{Nach RIP Konfiguration}
...
% WTF
% Wieso ist bei R2 keine Route zu m Netzwerk von R1 vorhanden? Steh grad total
% aufm Schlauch
