...
\label{pingroute}
\end{table}
PC 1 sendet Echo Request an WTHswitch1, welcher diese an WTHrouter1
weiterleitet. Von dort wird Anfrage zurück an den WTHswitch 1 geleitet.
Auffällig ist, dass WTHswitch1 im Anschluss (Zeitpunkt 0.004) die Anfrage sowohl
an PC3 als auch WTHswitch2 weiterleitet. Zu diesem Zeitpunkt ist dem Switch PC3 nicht
...
\newline
Der Echo Reply gelangt auf dem gleichen Weg zurück, allerdings ohne eine
Weiterleitung an P3.
\clearpage
