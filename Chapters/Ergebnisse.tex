\chapter{Beschreibung der verschiedenen Messungen und
Ergebnisdarstellung}\label{kap2}
...
zwischen Telefon 2 und der \acs{VSt} zu visualisieren wurde u.a. ``Die Technik
der Netze'' von Gerd Sigmund, als Quelle genutzt.\\
\newline
...
quittiert wird:\footnote{Die volständigen Frames, denen die Auschnitte
...
Anschluss, bei bestehender Schicht-2-Verbindung, statt. Außerdem lässt sich aus
...
Mit Senden der CONNECT ACKNOWLEDGE ist der Aufbau der Schicht 3 abgeschlossen.
...
Protokollmitschnitt, entfallen.\cite{siegmund2002technik}
\newline
...
Bei der normalen Wahl (Einzelwahl) werden die Ziffern der Rufnummer in einzelnen
...
SETUP-Nachricht bei Blockwahl, ausgefüllt. Gleichzeitig wurden Informationen aus
