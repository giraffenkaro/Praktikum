...
\newline
Durch \texit{show vlan} lässt sich die vorgenommene Konfiguration überprüfen:
\begin{lstlisting}
WTHswitch1#show vlan
...
\subsection{Konfigruation des zweiten
Switches}%TODO umbenennen
