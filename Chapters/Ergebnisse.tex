...
\newline
Die dritte aufgeführte Multicast-Adresse ist eine ``Solicited-Node'
Multicast-Adresse.\cite[15]{RFC4291}
\clearpage
...
Unicast-oder Anycast-Adresse werden dem 104 Bit langem Präfix
...
Alle statischen Routen werden aus dr Routingtabelle von R1 entfernt:
\begin{lstlisting}
