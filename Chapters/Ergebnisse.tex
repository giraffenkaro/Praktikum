...
besteht aus 3 Bit ``User_priority''. Weiterhin wird 1 Bit zu
Kompatibilitätszwecken genutzt, um unterschiedliche Bitreihenfolgen bei FDDI MAC
verarbeiten zu können. Darauf folgen 12 Bit VLAN-ID, welche zur Adressierung der
VLAN genutzt werden können und somit 4096 mögliche Kombinationen
zulässt.\cite{vlan}
...
Tagged VLANs
MAC-basiert
IP-Basiert laut pauly - layer 3 vlan?
...
% . Kommt VLAN-Trunking zum Einsatz, sind über einzelne 
...
\acs{STP} bezeichnet ein Protokoll zur Pfadoptimierung.\footnote{IEEE 802.1D}
