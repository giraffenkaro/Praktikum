...
deutlich geringere Organisationszeit der Switches aus (ca. 6 Sekunden).

\paragraph{Änderungen gegenüber STP}\mbox{}\\
Mit \acs{RSTP} werden neue Port-Zustände und neue Port-Rollen eingeführt.
Außerdem ändert sich das BPDU-Format und -Handling.
...
Wenn die Hosts an einem Switch unterschiedliche IP-Netze angehören
