...
\label{pingroute}
\end{table}
PC 1 sendet die Anfrage an WTHswitch1, welcher diese an WTHrouter1 weiterleitet.
Von dort wird Anfrage zurück an den WTHswitch 1 geleitet. Auffäig ist, dass 
WTHswitch1 im Anschluss (Zeitpunkt 0.004) die Anfrage sowohl an PC3 als
auch WTHswitch2 weiterleitet. Zu diesem Zeitpunkt ist dem Switch PC3 nicht
bekannt, somit erhält auch dieser die Anfrage, die er im Anschluss verwirft.
\newline
WTHswitch 2 erreicht im nächsten Schritt sein Ziel.
\newline
Die Antwort gelangt auf dem gleichen Weg zurück, allerding ohne eine
Weiterleitung an P3.

\paragraph{Pakete im Detail}
