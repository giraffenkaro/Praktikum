...
\begin{itemize}
  ...
  \item PC4 zu PC3
\end{itemize}
%wir gaben definitiv was falsch gemacht. die pings sollten nicht alle
% funktiioniren, also nur die vlan internen, nicht die externen
...
\subsubsection{Verbindung zwischen Router und Switch einrichten}
