...
Die Pings von Router 1 zu Router 2 über die Fast-Ethernet-Schnittstelle und von
Host 1 zu Host 2 funktionieren nicht, da noch keine Route zum Netzwerk
(172.18.0.0) bekannt ist.


Darüber hinaus kennt R2 das Ethernet Netzwerk von R1 (172.16.0.0) nicht. Die Pings können nicht von R1 oder H1
...
(\textit{show ip route}) im Anhang unter \ref{routingtables} zu finden.
\newline
