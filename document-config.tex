...
% ****************************************************************************************************
\newcommand{\myTitle}{Basic Access}
\newcommand{\myDegree}{Bachelor of Science (B.\,Sc.)\xspace}
\newcommand{\myDegreeType}{Bachelor\xspace}
\newcommand{\myDegreeCourse}{Kommunikationsinformatik}
\newcommand{\NameY}{Yannick Neumann, 3690024\xspace}
\newcommand{\NameL}{Laura-Ann Schiestel, 3686779\xspace}
\newcommand{\NameD}{Dominik Bergum, 3603490\xspace}
\newcommand{\NameM}{Jan-Merlin Geuskens, 3580970\xspace}
...
\newcommand{\myTime}{27.~Juni~2018\xspace}
...
% DIESE WERTE SIND NICHT ZU VERÃ„NDERN -- DO NOT CHANGE THESE VALUES
...
%Styles fÃ¼r verschiedene Sprachen festlegen, z.B. Java
\lstdefinestyle{Java}{
...
\hypersetup{
    ...
    pdftitle={\myTitle},%
    pdfauthor={\textcopyright\ \NameL, \myUni},%
    pdfsubject={},%
    pdfkeywords={},%
    pdfcreator={pdfLaTeX},%
